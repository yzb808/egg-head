...
public class PlayerSpendLY {
	...
	private Long redPacket;			// 红包
	private Long onHand;			// 一掌
	...
	public void setWashEquipment(Long washEquipment) {
	...
	public void setWashAnimal(Long washAnimal) {
		this.washAnimal = washAnimal;
	}
	public Long getWashPrecious() {
		return washPrecious;
	}
	public void setWashPrecious(Long washPrecious) {
		this.washPrecious = washPrecious;
	}
	...
	public Long getClother() {
		return clother;
	}
	public void setClother(Long clother) {
		this.clother = clother;
	}
	public Long getBaoShiJin() {
		return baoShiJin;
	}
	public void setBaoShiJin(Long baoShiJin) {
		this.baoShiJin = baoShiJin;
	}
	public Long getKaiShu() {
		return kaiShu;
	}
	public void setKaiShu(Long kaiShu) {
		this.kaiShu = kaiShu;
	}
	public Long getSongHua() {
		return songHua;
	}
	public void setSongHua(Long songHua) {
		this.songHua = songHua;
	}
	public Long getBaoLinDan() {
		return baoLinDan;
	}
	public void setBaoLinDan(Long baoLinDan) {
		this.baoLinDan = baoLinDan;
	}
	public Long getJuQingShanZi() {
		return juQingShanZi;
	}
	public void setJuQingShanZi(Long juQingShanZi) {
	...
	public void setXianJiWuKu(Long xianJiWuKu) {
		this.xianJiWuKu = xianJiWuKu;
	}
	public Long getJiuBaoLianDeng() {
		return jiuBaoLianDeng;
	}
	public void setJiuBaoLianDeng(Long jiuBaoLianDeng) {
		this.jiuBaoLianDeng = jiuBaoLianDeng;
	}
	public Long getHuoDongYaoShi() {
		return huoDongYaoShi;
	}
	public void setHuoDongYaoShi(Long huoDongYaoShi) {
		this.huoDongYaoShi = huoDongYaoShi;
	}
	public Long getGaoJiBaoShi() {
		return gaoJiBaoShi;
	}
	public void setGaoJiBaoShi(Long gaoJiBaoShi) {
		this.gaoJiBaoShi = gaoJiBaoShi;
	}
	public Long getLaBa() {
		return laBa;
	}
